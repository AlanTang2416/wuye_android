...
//                blogdetailTitleTx.setVisibility(View.VISIBLE);
            ...
            blogdetailGoodsPriceIv.setText("¥ " + mGoodsDetailsResponseModel.getBody().getPrice());
            ...
            public void onClick(View v) {
                if (!isLogin()) {
                    ...
                    if (mGetBlogDetailModel.getBody().get(0).getUser_id()
                            == MyBaseApplication.mGetUserInfoModel.getBody().getUserId()) {
